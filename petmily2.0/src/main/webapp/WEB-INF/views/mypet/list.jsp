...
<div id="content" class="container">
	<div id="content-body" class="col-12 mt-5">
		...
		<button type="button" class="btn btn-primary ml-3" data-toggle="modal"
			data-target="#exampleModalLong">반려동물 등록</button>
		<div class="ml-3 mt-5" id="update-order-by-div"></div>
		<!-- Modal -->
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLongTitle">반려동물 등록</h5>
					...
					<div class="modal-body">
						<form action="/PETMILYPROJECT/pet/insertPetAction.go"
							...
							<div class="form-group">
								<label for="insert-pet-basic-vaccination" class="col-form-label">기초
									예방 접종</label>
...
$(document).ready(function() {
	...
	/*누수 확인*/
        ...
        openWin = window.open("/PETMILYPROJECT/mypet/selectBreedByCode.go?pet_species="+$('#insert-pet-species').first().val(), //petBreedSearch.jsp
