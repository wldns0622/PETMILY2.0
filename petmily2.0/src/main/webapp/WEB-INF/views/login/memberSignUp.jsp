...
⑤ 주치의(집도의)의 변경 가능성과 사유에 대한 설명을 이 수술(시술, 검사, 마취, 의식하진정)의 시행 전에 의사로부터 들었음을 확인합니다.
                ...
                <div class="form-group" id="divId">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control onlyAlphabetAndNumber" id="id" data-rule-required="true" placeholder="15자이내의 알파벳, 숫자만 입력 가능합니다." maxlength="15">
                    </div>
                </div>
                ...
                <div class="form-group" id="divName">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control onlyHangul" id="name" data-rule-required="true" placeholder="한글만 입력 가능합니다." maxlength="100">
                    </div>
                </div>
                <div class="form-group" id="divNickname">
                    <label for="inputNickname" class="col-lg-2 control-label">별명</label>
                    <div class="col-lg-10">
                        <input type="text" class="form-control" id="nickname" data-rule-required="true" placeholder="별명" maxlength="100">
                    </div>
                </div>
                <div class="form-group" id="divAddress">
                    <label for="inputAddress" class="col-lg-2 control-label">주소</label>
                    <div class="col-lg-10">
                        <input type="address" class="form-control" id="address" data-rule-required="true" placeholder="주소" maxlength="200">
                    </div>
                </div>
