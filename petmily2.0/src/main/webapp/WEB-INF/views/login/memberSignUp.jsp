	...
	<div class="container">
		...
		<form class="form-horizontal" role="form" method="post" action="/member/memberSignUp">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio" id="emailReceiveYn" name="emailCheck" value="Y" checked> 동의합니다. <!-- name="emailReceiveYn" -->
					</label> <label class="radio-inline"> <input type="radio" id="emailReceiveYn" name="emailCheck" value="N"> 동의하지 않습니다. <!-- name="emailReceiveYn" -->
					</label>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-lg-10">
					<label class="radio-inline"> <input type="radio" id="smsReceiveYn" name="smsCheck" value="Y" checked> 동의합니다. <!-- name="smsReceiveYn" -->
					</label> <label class="radio-inline"> <input type="radio" id="smsReceiveYn" name="smsCheck" value="N"> 동의하지 않습니다. <!-- name="smsReceiveYn" -->
					</label>
				</div>
			</div>
			<div class="form-group">
